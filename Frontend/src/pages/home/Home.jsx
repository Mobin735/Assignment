...
export default function Home(params) {
    ...
    const projectPageAPICall = (projectName) => {
        navigate(`/project/${projectName}/projects`)
    }
    ...
    return (
        <>
            ...
            <div className='HomeContainer'>
                ...
                <div className="modal fade" style={{ background: '#dddddd73', paddingRight: "0px" }} id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content" style={{ borderRadius: "20px", border: "none" }}>
                            ...
                            <div className="modal-footer" style={{ borderTop: "none", columnGap: "15px" }}>
                                ...
                                <button style={{ background: "var(--primaryColor)", border: "none", borderRadius: "7px", color: "white", padding: "10px 20px", fontWeight: "600" }} type="button" data-bs-dismiss="modal">Create</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    projects == 0 ?
                        (
                            <div className='IntroContainer'>
                                ...
                                <button className='CreateNewProjectButton' type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        ...
                        (
                            <div className='ProejctsContainer' style={{ marginTop: "10px" }}>
                                <div className='ProjectsNavBar'>
                                    ...
                                    <button className='CreateNewProjectButton' style={{ padding: "10px 15px", height: 'fit-content' }} type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                ...
                                <div className='Projects'>
                                    <div className='Project' key="unique_id" onClick={() => projectPageAPICall('unique_ID')}>
